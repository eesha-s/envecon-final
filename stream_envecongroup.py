...
co2_temp_facet=ggplot(scatter_data, aes(x = 'Year', y = 'Value')) + geom_point() + geom_smooth(method = "lowess", se = False)+facet_wrap('~Label', scales='free_y', ncol=1)+labs(title='Portugal Emissions and Temperatures (1980-2022)')
